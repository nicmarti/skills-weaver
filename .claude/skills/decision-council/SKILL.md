...
Response can be in English or French, depending on the initial question that was asked.
...
After the chairman synthesis is complete, generate a visual HTML report and save it to the `docs/` folder.
