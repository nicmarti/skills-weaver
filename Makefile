...
$(BINARY_PREFIX)-adventure: cmd/adventure/main.go internal/adventure/*.go internal/ai/*.go internal/coherence/*.go internal/agent/*.go internal/npcmanager/*.go internal/npc/*.go internal/names/*.go
...
$(BINARY_PREFIX)-dm: cmd/dm/main.go internal/agent/*.go internal/dmtools/*.go internal/ui/*.go internal/npcmanager/*.go internal/coherence/*.go internal/npc/*.go
